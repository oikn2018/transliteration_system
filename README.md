...
|----------|----------|----------|
| Question 1 | [Question-1](https://github.com/oikn2018/CS6910_assignment_3/blob/main/run_wo_att.py) | Building an RNN | 
| Question 2 | [Question-2](https://github.com/oikn2018/CS6910_assignment_3/blob/main/sweeps_wo_att.py) | Code to run sweeps on Seq2Seq without Attention |
| Question 4 | [Question-4](https://github.com/oikn2018/CS6910_assignment_3/blob/main/run_wo_att.py) | Test best model on Test Data without Attention | 
| Question 5b | [Question-5b](https://github.com/oikn2018/CS6910_assignment_3/blob/main/run_w_att.py) | Test best model on Test Data with Attention |
| Question 5d | [Question-5d](https://github.com/oikn2018/CS6910_assignment_3/tree/main/visualization_code) | Code to generate Attention Heatmaps |
---
## Question 1
...
### Question 5(d)
Code to generate attention heatmaps for 10 inputs from test data can be found [here](https://github.com/oikn2018/CS6910_assignment_3/tree/main/visualization_code)

To execute it, download the code and associated Kalpurush.ttf file (for proper Bengali font in plots) and then run the following:
```python
pip install torchtext==0.6.0
pip install wandb
pip install wget
